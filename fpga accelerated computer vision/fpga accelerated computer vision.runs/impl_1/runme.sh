...
HD_PWD='C:/FPGA/fpga accelerated computer vision/fpga accelerated computer vision.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combined_withvision.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combined_withvision.tcl -notrace
