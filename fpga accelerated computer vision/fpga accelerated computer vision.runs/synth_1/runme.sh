...
HD_PWD='C:/FPGA/fpga accelerated computer vision/fpga accelerated computer vision.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combined_withvision.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combined_withvision.tcl
